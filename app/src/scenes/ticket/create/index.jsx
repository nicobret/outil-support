...
import Right from "./../create/right";
...
export default ({}) => {
  ...
  const onUploadImage = async (formatedMessage, ticket) => {
    try {
      const { ok, code, data } = await API.uploadFile(`/message/sendEmailFile/${ticket._id}`, files, {
  ...
  const handleNewTicket = async () => {
    ...
    try {
      ...
      const body = { subject, contactEmail: contact.email, canal: canal || "PLATFORM", tags, message: formatedMessage, files, copyRecipients };
